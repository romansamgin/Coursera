...
public:
    ...
    geo2d::Point GetPoint() const { return point_; }
...
public:
    explicit Building(geo2d::Rectangle position) : rectangle_(position)
    {}

    geo2d::Rectangle GetPosition() const { return rectangle_; }
...
public:
    explicit Tower(geo2d::Circle position) : circle_(position)
    {}

    geo2d::Circle GetPosition() const { return circle_; }
...
public:
    explicit Fence(geo2d::Segment position) : segment_(position)
    {}

    geo2d::Segment GetPosition() const { return segment_; }
...
bool Unit::CollideWith(const Unit& that) const {
    return geo2d::Collide(this->point_, that.GetPoint());
}

bool Unit::CollideWith(const Building& that) const {
    return geo2d::Collide(this->point_, that.GetPosition());
}
...
bool Building::CollideWith(const Unit& that) const  {
    return geo2d::Collide(this->rectangle_, that.GetPoint());
}

bool Building::CollideWith(const Building& that) const  {
    return geo2d::Collide(this->rectangle_, that.GetPosition());
}
...
bool Tower::CollideWith(const Unit& that) const  {
    return geo2d::Collide(this->circle_, that.GetPoint());
}

bool Tower::CollideWith(const Building& that) const  {
    return geo2d::Collide(this->circle_, that.GetPosition());
}
...
bool Fence::CollideWith(const Unit& that) const {
    return geo2d::Collide(this->segment_, that.GetPoint());
}

bool Fence::CollideWith(const Building& that) const {
    return geo2d::Collide(this->segment_, that.GetPosition());
}
